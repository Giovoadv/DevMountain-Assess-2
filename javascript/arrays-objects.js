...
function flatAnimals() {
  ...
  const join = [...forest, ...ocean, ... savannah, ... desert];
...
function getEllensInfo() {
    ...
    const helenDoughter = {...shippingInfo, ...contactInfo};
    helenDoughter.name = 'Ellen';
    helenDoughter.email = 'ellen@email.com';

    return helenDoughter;
